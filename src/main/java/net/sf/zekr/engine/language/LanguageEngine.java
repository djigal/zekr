...
public class LanguageEngine extends LanguageEngineNaming {
	...
	private LanguageEngine() {
		...
		// Check if language pack exists in classpath
		String packPath = language.getPackPath();
		java.io.InputStream is = getClass().getClassLoader().getResourceAsStream(packPath);
	...
	private void init() {
		...
		String packPath = language.getActiveLanguagePack().getPath();
