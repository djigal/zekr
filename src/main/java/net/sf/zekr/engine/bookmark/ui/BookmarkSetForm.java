...
public class BookmarkSetForm extends BaseForm {
	...
	public BookmarkSetForm(BookmarkSet bookmarkSet, Shell parent) {
		...
		shell.setImages(new Image[] {
			ImageUtils.loadFromClasspath(display, resource.getString("icon.bookmark.edit16")),
			ImageUtils.loadFromClasspath(display, resource.getString("icon.bookmark.edit32"))
		});
	...
	tree.addTreeListener(new TreeAdapter() {
		public void treeExpanded(TreeEvent e) {
			((TreeItem) e.item).setImage(ImageUtils.loadFromClasspath(display, resource.getString("icon.bookmark.openFolder")));
		}

		public void treeCollapsed(TreeEvent e) {
			((TreeItem) e.item).setImage(ImageUtils.loadFromClasspath(display, resource.getString("icon.bookmark.closeFolder")));
		}
	});
			...
			if (targetItem != null) {
				if (parentItem != null) {
					if (((BookmarkItem) targetItem.getData()).isFolder() && parentItem.getItemCount() == 1) {
						parentItem.setImage(ImageUtils.loadFromClasspath(display, resource.getString("icon.bookmark.closeFolder")));
					}
				}
				if (((BookmarkItem) targetItem.getData()).isFolder() && targetItem.getItemCount() == 0) {
					targetItem.setImage(ImageUtils.loadFromClasspath(display, resource.getString("icon.bookmark.openFolder")));
				}
			}
	...
	addFolderBut.setImage(ImageUtils.loadFromClasspath(display, resource.getString("icon.bookmark.newFolder")));
	...
	addItemBut.setImage(ImageUtils.loadFromClasspath(display, resource.getString("icon.bookmark.newItem")));
	...
	removeBut.setImage(ImageUtils.loadFromClasspath(display, resource.getString("icon.remove")));
	...
	editBut.setImage(ImageUtils.loadFromClasspath(display, resource.getString("icon.bookmark.edit16")));
	...
	gotoBut.setImage(ImageUtils.loadFromClasspath(display, resource.getString("icon.bookmark.goto")));
	...
	private void add(boolean isFolder) {
		...
		newTreeItem.setImage(ImageUtils.loadFromClasspath(display, resource.getString("icon.bookmark."
			...
			if (!tis[i].isDisposed()) {
				if (tis[i].getParentItem() != null) {
					if (tis[i].getParentItem().getItems().length == 1) {
						...
						tis[i].getParentItem().setImage(ImageUtils.loadFromClasspath(display, resource.getString("icon.bookmark.closeFolder")));
					}
				}
			}
			tis[i].dispose();
