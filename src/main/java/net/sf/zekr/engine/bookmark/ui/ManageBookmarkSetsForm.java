...
public class ManageBookmarkSetsForm extends BaseForm {
	...
	public ManageBookmarkSetsForm(Shell parent) {
		...
		shell.setImages(new Image[] {
			ImageUtils.loadFromClasspath(display, resource.getString("icon.bookmark.manage16")),
			ImageUtils.loadFromClasspath(display, resource.getString("icon.bookmark.manage32"))
		});
	...
	newButt.setImage(ImageUtils.loadFromClasspath(display, resource.getString("icon.add")));
	...
	removeButt.setImage(ImageUtils.loadFromClasspath(display, resource.getString("icon.remove")));
	...
	editButt.setImage(ImageUtils.loadFromClasspath(display, resource.getString("icon.bookmark.edit16")));
	...
	importButt.setImage(ImageUtils.loadFromClasspath(display, resource.getString("icon.bookmark.import")));
	...
	exportButt.setImage(ImageUtils.loadFromClasspath(display, resource.getString("icon.bookmark.export")));
	exportButt.setLayoutData(rd);
	// ...existing code...

	export4webButt.setToolTipText(meaning("EXPORT4WEB"));
	export4webButt.setImage(ImageUtils.loadFromClasspath(display, resource.getString("icon.bookmark.export4web")));
