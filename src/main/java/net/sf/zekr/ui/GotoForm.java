...
public class GotoForm extends BaseForm implements FocusListener {
	...
	private void init() {
		...
		shell.setImages(new Image[] {
			ImageUtils.loadFromClasspath(display, resource.getString("icon.goto.form16")),
			ImageUtils.loadFromClasspath(display, resource.getString("icon.goto.form32"))
		});
	...
	private void createSmartBody() {
		...
		cancelButton.setImage(ImageUtils.loadFromClasspath(display, resource.getString("icon.cancel")));
