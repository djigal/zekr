...
public class SearchResultNavigator {
	...
	private void init() {
		...
		final Image prevPageImg = ImageUtils.loadFromClasspath(display, isRTL ? resource.getString("icon.nextNext")
				: resource.getString("icon.prevPrev"));
		final Image nextPageImg = ImageUtils.loadFromClasspath(display, isRTL ? resource.getString("icon.prevPrev")
