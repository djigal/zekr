...
public class AboutForm extends BaseForm {
	...
	public void init() {
		...
		shell.setImages(new Image[] {
			ImageUtils.loadFromClasspath(display, resource.getString("icon.about16")),
			ImageUtils.loadFromClasspath(display, resource.getString("icon.about32")),
			ImageUtils.loadFromClasspath(display, resource.getString("icon.about48")),
			ImageUtils.loadFromClasspath(display, resource.getString("icon.about128")),
			ImageUtils.loadFromClasspath(display, resource.getString("icon.about256"))
		});
		...
		final Image image = ImageUtils.loadFromClasspath(display, resource.getString("image.smallLogo"));
